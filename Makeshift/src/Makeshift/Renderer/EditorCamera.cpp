...
namespace Makeshift {
	...
	void EditorCamera::updateView() {
		// m_Yaw = m_Pitch = 0.0f; // Lock rotation for full 2D
	...
	float EditorCamera::zoomSpeed() const {
		...
		speed = std::min(speed, 100.0f); // speed limit 100
		return speed;
	}
	...
	void EditorCamera::onEvent(Event& e) {
		...
		dispatcher.dispatch<MouseScrolledEvent>(MK_BIND_EVENT_FN(EditorCamera::onMouseScroll));
	}
